<script lang="ts">
    ...
    let subpage = "job";
    function GetData() {
        fetchNui("getGroup").catch((e) => console.error(e));
    }
    ...
    let stages = [
        {
            id: 1,
            name: "Step 1",
            description: "Lorem Ipsum dolor silit amat",
            done: true,
        },
        {
            id: 2,
        ...
        },
        {
            ...
            name: "Step 3",
            description:
                "Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat numquam quia sapiente nemo est illum facere, quisquam libero at, veritatis magnam ab. Qui reiciendis, eius numquam nisi eaque alias consequatur! Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat numquam quia sapiente nemo est illum facere, quisquam libero at, veritatis magnam ab. Qui reiciendis, eius numquam nisi eaque alias consequatur! Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat numquam quia sapiente nemo est illum facere, quisquam libero at, veritatis magnam ab. Qui reiciendis, eius numquam nisi eaque alias consequatur!",
            done: false,
        },
    ];
    onMount(GetData);
...
<Apps {topdata} appname="employment" debug={true}>
    {#if page === "main"}
        <div class="create">
            <div class="box">
                <div class="top">
    ...
    {:else if page === "group"}
        ...
        {:else if subpage == "job"}
            <div style="padding: 0 30px; height: 100%">
                <div class="title">Group Job Name</div>
                <div class="job-list">
